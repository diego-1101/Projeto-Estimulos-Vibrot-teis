...
# Remover indivíduo 1 do protocolo B CF 
'''
...
'''
Montando um Data Frame que engloba os dois procolos (B CF e B SF). 
...
# Criando o Data Frame do protocolo B sem agrupar
...
df_protB['nivel'] = df_protB['Complexidade'].apply(ev.map_niveis)
#df_protB['grupo_complexidade1'] = df_protB['grupo'].astype(str) + '_C' + df_protB['Complexidade'].astype(str)
df_protB['grupo_complexidade'] = df_protB['grupo'].astype(str) + '_' + df_protB['nivel'].astype(str)

# Salvando o Data Frame final em CSV
df_protB.to_csv('df_protB.csv',index=False)
